...
namespace
{
    ...
    auto handle_modify_op(irods::http::request_type& _req, irods::http::query_arguments_type& _args) -> irods::http::response_type;
    auto handle_add_child_op(irods::http::request_type& _req, irods::http::query_arguments_type& _args) -> irods::http::response_type;
    auto handle_remove_child_op(irods::http::request_type& _req, irods::http::query_arguments_type& _args) -> irods::http::response_type;
    auto handle_rebalance_op(irods::http::request_type& _req, irods::http::query_arguments_type& _args) -> irods::http::response_type;
