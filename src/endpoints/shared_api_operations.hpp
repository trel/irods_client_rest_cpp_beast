...
#define IRODS_HTTP_API_SHARED_API_OPERATION_FUNCTION_SIGNATURE(name) \
    auto name(irods::http::session_pointer_type _sess_ptr, irods::http::request_type& _req, irods::http::query_arguments_type& _args, const entity_type _entity_type) -> void
